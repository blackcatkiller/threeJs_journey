...
import './index.less'
import baked_shadow from './texture/bakedShadow.jpg'
import simple_shadow from './texture/simpleShadow.jpg'
...
function Lesson16() {
  ...
  const bakedShadow = textureLoader.load(baked_shadow)
  const simpleShadow = textureLoader.load(simple_shadow)
  /*****************Lights********************/
  //环境光
  ...
  useEffect(() => {
    ...
    //通常不必使用，通常使用texture，默认为false
    // renderer.shadowMap.enabled = true;

    //PCFSoftShadowMap 性能更好，开销略大，会丢失redius
